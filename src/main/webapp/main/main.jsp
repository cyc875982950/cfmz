...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-right ">
           <a href="#"> <span>退出登陆</span>&nbsp;<span class="glyphicon glyphicon-log-out"></span></a>
        </div>
        <div class="navbar-right container-fluid">
           <marquee>欢迎:<a  style="color: #ac2925">${sessionScope.name}</a> 来到本网站 </marquee>
        </div>
    </div>
</nav>
<div class="container-fluid">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <a href="javascript:$('#changeContent').load('echartsMap.jsp')">用户注册分布图</a>
                        </div>
                        <div class="panel-body">
                            <a href="javascript:$('#changeContent').load('echarts.jsp')">用户近7天注册图</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
