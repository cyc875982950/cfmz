    ...
    <script>
        $(function () {
            $.extend($.validator.messages, {
                required: "<span style='color: indianred'>不能为空</span>",
            })
            ...
            if(flag==true){
                $.ajax({
                    ...
                    data:{"username":$("#form-username").val(),"password":$("#form-password").val(),"yzm":$("#form-code").val()},
                    dataType:"json",
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${pageContext.request.contextPath}/val/yzm?t="+new Date().getTime());
            })
        })
    </script>
</head>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left" id="top">
                            <h3>Login to showall</h3>
                            <p>Enter your username and password to log on:</p>
                            <h5 id="p" style="color: #761c19"></h5>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px;width: 107px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/val/yzm">
